...
<required_reading>
Read `/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
