...
The keys live in `.claude/settings.json` (project) or `/Users/balkanitytours/GitHub/platform.balkanity/.claude/settings.json` (global) — **not** in `.planning/config.json`:
