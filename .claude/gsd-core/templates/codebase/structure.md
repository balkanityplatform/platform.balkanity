...
- Usage: Reference from command with `@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/balkanitytours/GitHub/platform.balkanity/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/balkanitytours/GitHub/platform.balkanity/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
