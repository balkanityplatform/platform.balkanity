...
<!-- For checkpoint task examples and patterns, see @/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
