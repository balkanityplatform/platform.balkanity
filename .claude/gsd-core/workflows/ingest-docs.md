...
```bash
INIT=$(node "/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/bin/gsd-tools.cjs" commit \
