...
<required_reading>
@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/user-story-template.md
@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/spidr-splitting.md
@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
