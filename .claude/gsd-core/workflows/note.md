...
- **Global scope**: `/Users/balkanitytours/GitHub/platform.balkanity/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/balkanitytours/GitHub/platform.balkanity/.claude/notes/`)
...
2. Glob `/Users/balkanitytours/GitHub/platform.balkanity/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/balkanitytours/GitHub/platform.balkanity/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/balkanitytours/GitHub/platform.balkanity/.claude/notes/` — works in any directory
