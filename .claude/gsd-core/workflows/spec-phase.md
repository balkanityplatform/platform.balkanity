...
```bash
INIT=$(node "/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/templates/spec.md.
