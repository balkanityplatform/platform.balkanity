...
INSTALL_JS_GLOBAL="/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
