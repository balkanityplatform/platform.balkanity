...
<template>
@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/Users/balkanitytours/GitHub/platform.balkanity/.claude/gsd-core/workflows/diagnose-issues.md
